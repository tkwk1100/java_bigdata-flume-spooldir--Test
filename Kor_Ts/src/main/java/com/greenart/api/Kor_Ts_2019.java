...
@RestController
public class Kor_Ts_2019 {
    @GetMapping("/Kor_Ts_2019")
    public Map < String, Object > getKor_Ts_2019(@RequestParam @Nullable String startDt, @RequestParam @Nullable String endDt) throws Exception {
        ...
        StringBuilder builder = new StringBuilder("https://api.odcloud.kr/api/15066827/v1/uddi:b46a71b0-fec1-4c75-a6a5-da3b3d40fab2");
        ...
        String filePath = "/home/Kor_Ts_2019/Ts_batch_log_2019/"+fileName;
        //파일 열기 (생성?)
        ...
        File newFile = new File("/home/Kor_Ts_2019/Ts_2019/" + fileName); // 복사된 파일 (flume spooldir 경로)
